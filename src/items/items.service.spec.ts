...
describe('ItemsService', () => {
  ...
  describe('findAll', () => {
    it('should return items for the bakery', async () => {
      const now = new Date();
      const mockItems = [{ id: 1, name: 'Item 1', slug: 'item-1', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now }];
  ...
  describe('findOne', () => {
    it('should return an item if found', async () => {
      const now = new Date();
      const mockItem = { id: 1, name: 'Item 1', slug: 'item-1', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now };
  ...
  describe('create', () => {
    it('should create and return an item scoped to the bakery', async () => {
      ...
      const mockItem = { id: 2, name: 'New Item', slug: 'new-item', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now };
  ...
  describe('update', () => {
    it('should update and return the item', async () => {
      ...
      const existing = { id: 1, name: 'Item 1', slug: 'item-1', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now };
