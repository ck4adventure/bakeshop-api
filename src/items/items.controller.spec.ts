...
describe('ItemsController', () => {
  ...
  describe('create', () => {
    it('should call itemService.create and return its result', async () => {
      ...
      const result = { id: 1, name: 'New Item', slug: 'new-item', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now };
  ...
  describe('findAll', () => {
    it('should call itemService.findAll and return its result', async () => {
      const now = new Date();
      const result = [{ id: 1, name: 'Item 1', slug: 'item-1', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now }];
  ...
  describe('update', () => {
    it('should call itemService.update and return its result', async () => {
      ...
      const result = { id: 1, name: 'Updated Item', slug: 'updated-item', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now };
  ...
  describe('remove', () => {
    it('should call itemService.remove and return its result', async () => {
      const now = new Date();
      const result = { id: 1, name: 'Deleted Item', slug: 'deleted-item', bakeryId: BAKERY_ID, createdAt: now, updatedAt: now };
